...
<head>
    ...
    <link rel="stylesheet" href="template/icheck-bootstrap.min.css">
    <link rel="stylesheet" href="template/adminlte.min.css?v=3.2.0">
    <script nonce="01732381-0804-49c3-8f25-5ffde8011f2f">
        try {
            (function(w, d) {
                ! function(j, k, l, m) {
                    j[l] = j[l] || {};
...
<script src="template/adminlte.min.js?v=3.2.0"></script>
</body>
